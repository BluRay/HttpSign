...
////                    itemsMap = new HashMap<String, String>();  
    ...
    public static void main(String[] args) {  
        HashMap<String, String> dataMap = (HashMap)JavaRead_Ini2.getItemsBySectionName("aaa", new File("/home/yangkee/HttpSign.ini"));  
        Iterator iter = dataMap.entrySet().iterator();  
        while(iter.hasNext()){  
            Map.Entry entry = (Map.Entry)iter.next();  
            System.out.println(entry.getKey()+":"+entry.getValue());  
        } 
        System.out.println(JavaRead_Ini2.getValue("sign", "code", "/home/yangkee/HttpSign.ini"));
    }  
}
